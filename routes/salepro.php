...
use App\Http\Controllers\SalePro\Auth\LoginController;
use App\Http\Controllers\SalePro\AccountsController;

Route::get('login', [LoginController::class, 'showLoginForm'])->name('salepro.login');
Route::post('login', [LoginController::class, 'login'])->name('salepro.login.submit');
Route::post('logout', [LoginController::class, 'logout'])->name('salepro.logout');

use App\Http\Controllers\SalePro\AddonInstallController;
use App\Http\Controllers\SalePro\AdjustmentController;
use App\Http\Controllers\SalePro\AttendanceController;
use App\Http\Controllers\SalePro\BillerController;
use App\Http\Controllers\SalePro\BrandController;
use App\Http\Controllers\SalePro\CashRegisterController;
use App\Http\Controllers\SalePro\CategoryController;
use App\Http\Controllers\SalePro\ProductTypeController;
use App\Http\Controllers\SalePro\ClientAutoUpdateController;
use App\Http\Controllers\SalePro\CouponController;
use App\Http\Controllers\SalePro\CurrencyController;
use App\Http\Controllers\SalePro\CustomerController;
use App\Http\Controllers\SalePro\CustomerGroupController;
use App\Http\Controllers\SalePro\CustomFieldController;
use App\Http\Controllers\SalePro\DashboardController;
use App\Http\Controllers\SalePro\DeliveryController;
use App\Http\Controllers\SalePro\DepartmentController;
use App\Http\Controllers\SalePro\DeveloperSectionController;
use App\Http\Controllers\SalePro\DiscountController;
use App\Http\Controllers\SalePro\DiscountPlanController;
use App\Http\Controllers\SalePro\EmployeeController;
use App\Http\Controllers\SalePro\ExpenseCategoryController;
use App\Http\Controllers\SalePro\ExpenseController;
use App\Http\Controllers\SalePro\IncomeCategoryController;
use App\Http\Controllers\SalePro\IncomeController;
use App\Http\Controllers\SalePro\GiftCardController;
use App\Http\Controllers\SalePro\CourierController;
use App\Http\Controllers\SalePro\HolidayController;
use App\Http\Controllers\SalePro\HomeController;
use App\Http\Controllers\SalePro\LanguageController;
use App\Http\Controllers\SalePro\LanguageSettingController;
use App\Http\Controllers\SalePro\MoneyTransferController;
use App\Http\Controllers\SalePro\NotificationController;
use App\Http\Controllers\SalePro\PayrollController;
use App\Http\Controllers\SalePro\ProductController;
use App\Http\Controllers\SalePro\PurchaseController;
use App\Http\Controllers\SalePro\QuotationController;
use App\Http\Controllers\SalePro\ReportController;
use App\Http\Controllers\SalePro\ReturnController;
use App\Http\Controllers\SalePro\ReturnPurchaseController;
use App\Http\Controllers\SalePro\RoleController;
use App\Http\Controllers\SalePro\SaasInstallController;
use App\Http\Controllers\SalePro\SaleController;
use App\Http\Controllers\SalePro\SettingController;
use App\Http\Controllers\SalePro\StockCountController;
use App\Http\Controllers\SalePro\SupplierController;
use App\Http\Controllers\SalePro\TableController;
use App\Http\Controllers\SalePro\TaxController;
use App\Http\Controllers\SalePro\TransferController;
use App\Http\Controllers\SalePro\UnitController;
use App\Http\Controllers\SalePro\UserController;
use App\Http\Controllers\SalePro\WarehouseController;
use App\Http\Controllers\SalePro\SmsTemplateController;
use App\Http\Controllers\SalePro\PackingSlipController;
use App\Http\Controllers\SalePro\ChallanController;
use App\Http\Controllers\SalePro\BarcodeController;
use App\Http\Controllers\SalePro\LabelsController;
use App\Http\Controllers\SalePro\BillController;
use App\Http\Controllers\SalePro\PaymentController;
...
// Auth routes handled by LenzBreeze main web.php
...
Route::group(['middleware' => ['common', 'auth', 'active']], function() {
    ...
    Route::controller(ProductController::class)->group(function () {
        ...
        Route::get('products/search-autocomplete', 'searchAutocomplete')->name('products.search_autocomplete');
    ...
    Route::controller(ProductTypeController::class)->group(function () {
        Route::post('product_type/import', 'import')->name('product_type.import');
        Route::post('product_type/deletebyselection', 'deleteBySelection');
        // Route::get('product_type', 'index')->name('product_type.index');
        Route::post('product_type/data', 'data');
    });
    ...
    Route::controller(SaleController::class)->group(function () {
        ...
        Route::get('sales/lims_product_search_new', 'limsProductSearchNew')->name('product_sale.search_new');
        ...
        Route::get('sales/lab_receipt/{id}', 'genLabReceipt')->name('sale.lap_receipt');
        Route::get('sales/address-print/{id}', 'addressPrint')->name('sale.address_print');
        ...
        Route::get('sales/order', 'create');
        Route::get('sales/{id}/order', 'edit');

    });
    Route::resource('sales', SaleController::class);

    Route::controller(BillController::class)->group(function () {
        Route::post('bill/bill-data', 'billData');
        Route::get('bill/bill-generate', 'billGenerate');
        Route::get('bill/bill-print', 'printInvoice')->name('bill.print');
        Route::get('bill/bill-date', 'billByDate')->name('bill.date');
        Route::post('bill/bill-date-data', 'billByDateData')->name('bill.date.data');

        Route::get('bill/bill-monthly', 'billMonthly')->name('bill.monthly');
        Route::post('bill/bill-monthly-data', 'billMonthlyData')->name('bill.monthly.data');
        Route::get('bill/bill-monthly-generate', 'billMonthlyGenerate')->name('bill.monthly.generate');
        // Route::get('bill/bill-montly-print', 'printMontlyInvoice')->name('bill.montly.print');
    });
    Route::resource('bill', BillController::class);

    Route::controller(PaymentController::class)->group(function () {
        Route::post('payment/data', 'data');
        Route::post('payment/save', 'save')->name('payment.save');
    ...
    Route::controller(ReportController::class)->group(function () {
        Route::prefix('report')->group(function () {
            ...
            Route::get('customer_report', 'customerReport')->name('report.customer');
            Route::get('customer_report_print', 'customerSaleDataPrint')->name('report.customer_print');
            ...
            Route::get('customer-group', 'customerGroupReport')->name('report.customer_group');
            Route::get('customer_group_report_print', 'customerGroupReportPrint')->name('report.customer_group_print');
            Route::get('gst_export','gstExport')->name('gst.export');
