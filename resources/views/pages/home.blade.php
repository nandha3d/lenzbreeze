    ...
    <div class="container-custom py-8">
        <div class="flex flex-col sm:flex-row items-center justify-center gap-8 md:gap-16">
            <div class="flex items-center gap-3">
                <img src="{{ asset('images/logo-icon.png') }}" alt="Lenz Breeze" class="w-14 h-14 object-contain">
                <div>
                    <span class="font-display font-bold text-lg text-brand-500">Lenz Breeze</span>
                    <span class="block text-xs text-warm-400">Premium Range</span>
                </div>
            </div>
            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    <span class="font-display font-bold text-lg text-warm-800">EYE MEK</span>
                    <span class="block text-xs text-warm-400">Value Range</span>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div class="order-2 lg:order-1">
                ...
                <h2 class="font-display text-4xl md:text-5xl font-bold text-white leading-tight">
                    Seamless Sight.<br>
                    <span class="text-accent-400">Absolute Protection.</span>
                </h2>
                <p class="text-white/70 text-lg mt-6 leading-relaxed">
                    Move through your day with zero interruptions. Our Premium Progressive RX Lenses offer a smooth transition from far to near, enhanced with the ultimate protective suite:
                </p>
                ...
                <div class="mt-10 p-4 rounded-xl bg-white/5 border border-white/10 inline-block">
                    <p class="text-accent-400 font-display font-medium">Tagline: <span class="text-white italic">No lines. No limits. Just perfect vision.</span></p>
                </div>
            </div>
                ...
                <div class="relative">
                    ...
                    <div class="glass-card overflow-hidden ring-1 ring-white/20 shadow-2xl rounded-2xl">
                        ...
                        <div class="absolute inset-x-0 bottom-0 p-6 bg-gradient-to-t from-black/80 to-transparent">
                            <div class="text-white/50 text-xs font-bold uppercase tracking-widest">Eye Mek Series</div>
                            <div class="text-white font-display text-xl font-bold">Premium Progressive RX</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            @foreach($featuredProducts ?? [] as $product)
                ...
                <a href="{{ route('products.show', $product->slug ?? '#') }}" class="card group">
                    <div class="aspect-[4/3] bg-gradient-to-br from-brand-50 to-accent-50 flex items-center justify-center relative overflow-hidden">
                        <img src="https://images.unsplash.com/photo-1574258495973-f010dfbb5371?w=400&h=300&fit=crop&auto=format" alt="{{ $product->name ?? 'Product' }}" class="absolute inset-0 w-full h-full object-cover opacity-30">
