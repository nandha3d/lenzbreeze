...
@section('content')
{{-- Hero Section - Premium Dark Variation --}}
<section class="hero-section relative min-h-[90vh] flex items-center bg-brand-950 overflow-hidden">
    {{-- High-end ambient lights --}}
    <div class="absolute top-0 left-0 w-full h-full">
        <div class="absolute -top-1/4 -left-1/4 w-1/2 h-1/2 bg-accent-500/10 blur-[120px] rounded-full"></div>
        <div class="absolute -bottom-1/4 -right-1/4 w-1/2 h-1/2 bg-brand-500/10 blur-[120px] rounded-full"></div>
    </div>
    
    <div class="container-custom relative z-10">
        <div class="max-w-4xl mx-auto text-center">
            <div class="inline-flex items-center gap-3 px-6 py-2 rounded-full bg-white/5 border border-white/10 text-accent-400 text-sm font-medium tracking-widest uppercase mb-8">
            ...
            <h1 class="font-display text-5xl md:text-7xl font-bold text-white leading-tight">
                ...
                <span class="text-transparent bg-clip-text bg-gradient-to-r from-accent-400 to-brand-400">Optical Masterpieces</span>
            </h1>
            <p class="text-xl text-white/60 mt-8 max-w-2xl mx-auto leading-relaxed">
                Experience luxury optics with Lenz Breeze. Our premium lens technology combines state-of-the-art engineering with sophisticated aesthetics.
            </p>
            <div class="flex flex-wrap justify-center gap-6 mt-12">
                <a href="{{ route('products') }}" class="group relative px-10 py-5 bg-accent-500 text-brand-950 font-bold rounded-full overflow-hidden transition-all hover:scale-105 active:scale-95">
                    <span class="relative z-10">Discover Collections</span>
                    <div class="absolute inset-0 bg-white/20 translate-y-full group-hover:translate-y-0 transition-transform duration-300"></div>
                </a>
                <a href="{{ route('contact') }}" class="px-10 py-5 bg-white/5 text-white font-bold border border-white/20 rounded-full hover:bg-white/10 transition-all">
                    Consult an Expert
                </a>
            </div>
        </div>
    ...
    {{-- Bottom fade --}}
    <div class="absolute bottom-0 left-0 w-full h-32 bg-gradient-to-t from-warm-50 to-transparent"></div>
</section>
...
<section class="bg-white border-b border-warm-200/50">
    <div class="container-custom py-8">
        <div class="flex flex-col sm:flex-row items-center justify-center gap-8 md:gap-16">
            ...
            <div class="flex items-center gap-3">
                <div class="w-12 h-12 rounded-xl bg-warm-800 flex items-center justify-center text-white">EM</div>
                <div>
