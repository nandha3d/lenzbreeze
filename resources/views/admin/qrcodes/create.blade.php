...
@section('page_title', 'Generate QR Code')
...
<div class="max-w-5xl mx-auto">
    <div class="flex items-center gap-4 mb-6">
        ...
        <div>
            <h1 class="text-2xl font-bold text-warm-800">Generate New QR Code</h1>
            <p class="text-sm text-warm-400 mt-0.5">Fill in the details — the preview updates live.</p>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-5 gap-6" x-data="qrBuilder()" x-init="init()">
        ...
        <div class="lg:col-span-3">
            <form id="qrForm" action="{{ route('admin.qrcodes.store') }}" method="POST" class="space-y-5">
                @csrf
                ...
                <div class="bg-white rounded-2xl border border-warm-200 shadow-sm p-6 sm:p-8 space-y-5">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <textarea name="content" id="content" rows="3" required maxlength="2048"
                                  ...
                                  x-model="content">{{ old('content') }}</textarea>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        ...
                        <div class="space-y-1.5">
                            ...
                            <select name="size" id="size"
                                ...
                                <option value="2048" selected>2048 × 2048 px  (2K / print)</option>
                            </select>
                ...
                <div class="flex justify-end gap-3">
                    <a href="{{ route('admin.qrcodes') }}" class="btn-secondary">Cancel</a>
                    <button type="submit" class="btn-primary min-w-[160px]">Save QR Code</button>
                </div>
            </form>
        </div>
...
function qrBuilder() {
    return {
        ...
        fgColor: @json(old('fg_color', '#003b3c')),
        size: @json(old('size', '256')),
        qr: null,
        debounceTimer: null,
        ...
        refresh() {
            ...
            this.debounceTimer = setTimeout(() => {
                ...
                // Update color by re-creating — qrcodejs doesn't expose color update
