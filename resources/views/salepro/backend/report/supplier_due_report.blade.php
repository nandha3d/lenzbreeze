        ...
        <table id="report-table" class="table table-hover">
            ...
            <tbody>
                @foreach($lims_purchase_data as $key => $purchase_data)
                    ...
                    <?php
                        $supplier = DB::connection('salepro')->table('suppliers')->find($purchase_data->supplier_id);
                        $returned_amount = DB::connection('salepro')->table('return_purchases')->where('purchase_id', $purchase_data->id)->sum('grand_total');
                    ?>
                    <tr>
                        <td>{{$key}}</td>
