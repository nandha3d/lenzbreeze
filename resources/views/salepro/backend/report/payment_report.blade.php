    ...
    <div class="table-responsive mb-4">
        <table id="report-table" class="table table-hover">
            ...
            <tbody>
                ...
                <?php
                    $sale = DB::connection('salepro')->table('sales')->find($payment->sale_id);
                    $purchase = DB::connection('salepro')->table('purchases')->find($payment->purchase_id);
                    $user = DB::connection('salepro')->table('users')->find($payment->user_id);
                ?>
                <tr>
                    <td></td>
