...
<script type="text/javascript">
    ...
    $("#bill_gen_btn").on("click", function(){
        ...
        $.ajax({
            ...
            data: {'bill_date': bill_date, customer_id},
            dataType: 'json',
            context: this,
        }).done(function(data) {
            $("#loader").hide();
    ...
    $(".print-btn").on("click", function(){
        ...
        location.href = "{{route('bill.print')}}?bill_date="+bill_date+"&tax_rate="+rate_type +"&warehouse="+warehouse_id;
    ...
    var columns = [{"data": "id"}, {"data": "date"}, {"data": "reference_no"}, {"data": "customer"},{"data": "total_order"}, {"data": "total_qty"}, {"data": "grand_total"}, {"data": "returned_amount"}, {"data": "paid_amount"}, {"data": "due"}, {"data": "options"}];
