  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      ...
      <form>
        ...
        <div class="form-group">
          <label>{{trans('file.Percentage')}}(%) * <i class="dripicons-question" data-toggle="tooltip" title="{{trans('file.If you want to sell your product at default price, then the percentage value must be zero.')}}"></i></label>
