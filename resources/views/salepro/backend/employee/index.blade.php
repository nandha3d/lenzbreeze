                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                ...
                                <li>
                                    <button type="button" data-id="{{$employee->id}}" data-name="{{$employee->name}}" data-email="{{$employee->email}}" data-phone_number="{{$employee->phone_number}}" data-department_id="{{$employee->department_id}}" data-address="{{$employee->address}}" data-city="{{$employee->city}}" data-country="{{$employee->country}}" data-staff_id="{{$employee->staff_id}}"
                                        data-emergency_number="{{$employee->emergency_number}}" data-date_of_joining="{{$employee->date_of_joining}}" class="edit-btn btn btn-link" data-toggle="modal" data-target="#editModal"><i class="dripicons-document-edit"></i> {{trans('file.edit')}}</button>
                                </li>
                                @endif
                                <li class="divider"></li>
              ...
              <p class="italic"><small>{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <input type="text" name="date_of_joining" class="form-control date">
                    </div>
                    <div class="col-md-6 form-group">
...
<script type="text/javascript">
    ...
    $(document).on('click', '.edit-btn', function() {
        ...
        $("#editModal input[name='emergency_number']").val( $(this).data('emergency_number') );
        $("#editModal input[name='date_of_joining']").val( $(this).data('date_of_joining') );
