        ...
        <table id="notification-table" class="table">
            ...
            <tbody>
                ...
                <?php 
                    ...
                    $from_user = \DB::connection('salepro')->table('users')->select('name')->where('id', $data->sender_id)->first();
                    $to_user = \DB::connection('salepro')->table('users')->select('name')->where('id', $data->receiver_id)->first();
                ?>
