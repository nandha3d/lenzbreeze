        <ul id="side-main-menu" class="side-menu list-unstyled d-print-none">
            ...
            <ul id="product" class="collapse list-unstyled ">
                ...
                <li id="type-menu"><a href="{{route('product_type.index')}}">Type</a></li>
                @endif
            ...
            <ul id="sale" class="collapse list-unstyled ">
                ...
                <li id="payment-data-menu"><a href="{{route('payment.index')}}">Payment</a></li>

                <li id="sale-bill-data-menu"><a href="{{route('bill.date')}}">Bill Data</a></li>
                <li id="sale-bill-menu"><a href="{{route('bill.index')}}">Daily Bill</a></li>

                <li id="sale-bill-menu"><a href="{{route('bill.monthly')}}">Monthly Bill</a></li>

                <li id="sale-list-menu"><a href="{{route('sales.index')}}">Order List</a></li>
                @endif
                @if($sale_add_permission_active)
                {{-- <li><a href="{{route('sale.pos')}}">POS</a></li> --}}
                <li id="sale-create-menu"><a href="{{route('sales.create')}}">Create Order</a></li>
            ...
            <li><a href="#setting" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-gear"></i><span>{{trans('file.settings')}}</span></a>
                <ul id="setting" class="collapse list-unstyled ">
                    ...
                    <li id="languages"><a href="{{url('admin/languages/')}}"> {{trans('file.Languages')}}</a></li>
                </ul>
            </li>
        </ul>
