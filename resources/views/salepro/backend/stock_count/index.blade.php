    ...
    <div class="table-responsive">
        <table id="stock-count-table" class="table stock-count-list">
            ...
            <tbody>
                ...
                <?php
                    $warehouse = DB::connection('salepro')->table('warehouses')->find($stock_count->warehouse_id);
                    $category_name = [];
                    $brand_name = [];
                ...
                <tr>
                    ...
                    <td>{{$stock_count->category_id}}
                        {{-- @if($stock_count->category_id)
                            @foreach(explode(",",$stock_count->category_id) as $cat_key=>$category_id)
                            @php
                                $category = \DB::connection('salepro')->table('categories')->find($category_id);
                    ...
                    <td>
                        @if($stock_count->brand_id)
                            ...
                            @php
                                $brand = \DB::connection('salepro')->table('brands')->find($brand_id);
