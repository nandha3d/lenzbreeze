        ...
        <table id="department-table" class="table">
            <thead>
                <tr>
                    ...
                    <th style="width:65%">{{trans('file.Description')}}</th>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form>
                    <div class="form-group">
                        <label>Envato Purchase Code *</label>
                        {{Form::text('purchase_code',null,array( 'class' => 'form-control', 'placeholder' => 'Type envato purchase code for eCommerce addon...'))}}
                    </div>
                    <div class="form-group">
                        <input type="submit" value="{{trans('file.submit')}}" class="btn btn-primary">
                    </div>
