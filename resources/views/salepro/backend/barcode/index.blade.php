...
<section>
    <div class="container-fluid">
        <a href="{{route('barcodes.create')}}" class="btn btn-info add-sale-btn"><i class="dripicons-plus"></i> {{trans('file.Add New Setting')}}</a>&nbsp;
    </div>
        ...
        <table id="barcode-table" class="table" style="width: 100%">
            <thead>
                <tr>
                    ...
                    <th>{{trans('file.Sticker Sheet setting Name')}}</th>
                    <th>{{trans('file.Sticker Sheet setting Description')}}</th>
