    ...
    <div id="receipt-data">
        ...
        <table class="table-data">
            ...
            <!-- <tfoot> -->
                ...
                <tr>
                    <th colspan="4" style="text-align:left">{{trans('file.Discount')}}</th>
                ...
                <tr>
                    ...
                    <th class="centered" colspan="5">{{trans('file.In Words')}}: <span>{{$currency_code}}</span> <span>{{str_replace("-"," ",$numberInWords)}}</span></th>
                    @else
                    <th class="centered" colspan="5">{{trans('file.In Words')}}: <span>{{str_replace("-"," ",$numberInWords)}}</span> <span>{{$currency_code}}</span></th>
                    @endif
                </tr>
            </tbody>
            <!-- </tfoot> -->
