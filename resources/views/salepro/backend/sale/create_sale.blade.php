    ...
    <div class="side-navbar-wrapper">
      ...
      <div class="main-menu">
        <ul id="side-main-menu" class="side-menu list-unstyled">
          ...
          @endif
          <?php
            $index_permission = DB::connection('salepro')->table('permissions')->where('name', 'sales-index')->first();
            $index_permission_active = DB::connection('salepro')->table('role_has_permissions')->where([
                    ['permission_id', $index_permission->id],
                    ['role_id', $role->id]
                ])->first();
          ...
          <li><a href="#return" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-archive"></i><span>{{trans('file.return')}}</span></a>
            <ul id="return" class="collapse list-unstyled ">
              <?php
                $index_permission = DB::connection('salepro')->table('permissions')->where('name', 'returns-index')->first();
                $index_permission_active = DB::connection('salepro')->table('role_has_permissions')->where([
                        ['permission_id', $index_permission->id],
                        ['role_id', $role->id]
                    ])->first();
              ...
              @endif
              <?php
                $index_permission = DB::connection('salepro')->table('permissions')->where('name', 'purchase-return-index')->first();
                $index_permission_active = DB::connection('salepro')->table('role_has_permissions')->where([
                        ['permission_id', $index_permission->id],
                        ['role_id', $role->id]
                    ])->first();
          ...
          <li><a href="#people" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-user"></i><span>{{trans('file.People')}}</span></a>
            <ul id="people" class="collapse list-unstyled ">
              <?php $index_permission_active = DB::connection('salepro')->table('permissions')
              ...
              <?php $add_permission_active = DB::connection('salepro')->table('permissions')
                    ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                    ->where([
              ...
              @endif
              <?php
                $index_permission = DB::connection('salepro')->table('permissions')->where('name', 'customers-index')->first();
                $index_permission_active = DB::connection('salepro')->table('role_has_permissions')->where([
                        ['permission_id', $index_permission->id],
                        ['role_id', $role->id]
                    ])->first();
              ...
              <?php
                $add_permission = DB::connection('salepro')->table('permissions')->where('name', 'customers-add')->first();
                $add_permission_active = DB::connection('salepro')->table('role_has_permissions')->where([
                    ['permission_id', $add_permission->id],
                    ['role_id', $role->id]
                ])->first();
              ...
              @endif
              <?php
                $index_permission = DB::connection('salepro')->table('permissions')->where('name', 'billers-index')->first();
                $index_permission_active = DB::connection('salepro')->table('role_has_permissions')->where([
                        ['permission_id', $index_permission->id],
                        ['role_id', $role->id]
                    ])->first();
              ...
              <?php
                $add_permission = DB::connection('salepro')->table('permissions')->where('name', 'billers-add')->first();
                $add_permission_active = DB::connection('salepro')->table('role_has_permissions')->where([
                    ['permission_id', $add_permission->id],
                    ['role_id', $role->id]
                ])->first();
              ...
              @endif
              <?php
                $index_permission = DB::connection('salepro')->table('permissions')->where('name', 'suppliers-index')->first();
                $index_permission_active = DB::connection('salepro')->table('role_has_permissions')->where([
                        ['permission_id', $index_permission->id],
                        ['role_id', $role->id]
                    ])->first();
              ...
              <?php
                $add_permission = DB::connection('salepro')->table('permissions')->where('name', 'suppliers-add')->first();
                $add_permission_active = DB::connection('salepro')->table('role_has_permissions')->where([
                    ['permission_id', $add_permission->id],
                    ['role_id', $role->id]
                ])->first();
            ...
            <?php
              ...
              $due_report_active = DB::connection('salepro')->table('permissions')
                    ...
                    ->where([
                      ...
                      ['role_id', $role->id] ])->first();
              $supplier_due_report_active = DB::connection('salepro')->table('permissions')
                        ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                        ->where([
                    ...
                    <div class="card-body">
                        ...
                        @php
                            ...
                            if($lims_sale_data->coupon_id)
                                $lims_coupon_data = DB::connection('salepro')->table('coupons')->find($lims_sale_data->coupon_id);
                        @endphp
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="table-responsive">
                                        <table id="myTable" class="table table-hover table-striped order-list table-fixed">
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                <?php
                                                    $product_data = DB::connection('salepro')->table('products')->find($product_sale->product_id);
                                                    ...
                                                    $tax = DB::connection('salepro')->table('taxes')->where('rate',$product_sale->tax_rate)->first();
                                                    $unit_name = array();
                                                    $unit_operator = array();
                                                    $unit_operation_value = array();
                                                    if($product_data->type == 'standard'){
                                                        $units = DB::connection('salepro')->table('units')->where('base_unit', $product_data->unit_id)->orWhere('id', $product_data->unit_id)->get();
