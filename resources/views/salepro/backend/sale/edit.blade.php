                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <p><strong>{{ $lims_sale_data->order_no }}</strong></p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Brand *</label>
                                            <select  name="brand_id" id="brand_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Select Brand...">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select  name="product_type_id" id="product_type_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Select Product Type...">
                                        ...
                                        <div class="table-responsive mt-3">
                                            <table id="myTable" class="table table-hover order-list">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <td>{{$product_data->name}} <button type="button" class="edit-product btn btn-link" data-toggle="modal" data-target="#editModal"> <i class="dripicons-document-edit"></i></button> <input type="hidden" class="product-type" value="{{$product_data->type}}" data-sph="{{$product_sale->sph}}" data-cyl="{{$product_sale->cyl}}" data-axis="{{$product_sale->axis}}" /></td>
                                                        <td>{{$product_data->code}}</td>
                                                        <td width="10%"><input type="number" class="form-control qty" name="qty[]" value="{{$product_sale->qty}}" step="any" required/></td>
                                                        ...
                                                        {{-- <td>N/A</td> --}}
                                                        @endif
                                                        <td width="10%"><input type="text" class="form-control sph" name="sph[]" value="{{$product_sale->sph}}"  required/></td>
                                                        <td width="10%"><input type="text" class="form-control cyl" name="cyl[]" value="{{$product_sale->cyl}}"  required/></td>
                                                        <td width="10%"><input type="text" class="form-control axis" name="axis[]" value="{{$product_sale->axis}}"  required/></td>



                                                        {{-- <td>
                                                            <div>SPH: {{$product_sale->sph}}</div>
                                                            <div>CYL: {{$product_sale->cyl}}</div>
                                                            <div>AXIS: {{$product_sale->axis}}</div>
                                                        </td> --}}
                                                        <td></td>
                                                        ...
                                                        <input type="hidden" class="sale_sph" name="sale_sph[]" value="{{$product_sale->sph}}"/>
                                                        <input type="hidden" class="sale_cyl" name="sale_cyl[]" value="{{$product_sale->cyl}}"/>
                                                        <input type="hidden" class="sale_axis" name="sale_axis[]" value="{{$product_sale->axis}}"/>
                                                        @if($tax)
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        @if($lims_sale_data->coupon_id)
                                            @php
                                                $coupon_data = DB::connection('salepro')->table('coupons')->find($lims_sale_data->coupon_id);
                                            @endphp
                    ...
                    <form>
                        <div class="row modal-element">
                            {{-- <div class="col-md-4 form-group">
                                <label>SPH</label>
                                <input type="number" step="any" name="edit_sph" class="form-control">
                            </div>
                            <div class="col-md-4 form-group">
                                <label>CYL</label>
                                <input type="number" step="any" name="edit_cyl" class="form-control">
                            </div>
                            <div class="col-md-4 form-group">
                                <label>AXIS</label>
                                <input type="number" step="any" name="edit_axis" class="form-control">
                            </div> --}}
                            <div class="col-md-4 form-group">
...
<script type="text/javascript">
    ...
    for(rowindex  =0; rowindex <= rownumber; rowindex++){
        ...
        sale_sph.push($('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('.sale_sph').val());
        sale_cyl.push($('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('.sale_cyl').val());
        sale_axis.push($('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('.sale_axis').val());
    ...
    //     return;
    // }
    // $.get('../getproduct/' + id + '?brand='+brand_id+'&category='+category_id +'&product_type='+product_type_id, function(data) {
    //     lims_product_array = [];
    //     product_code = data[4];
    //     product_name = data[0];
    //     product_qty = data[3];
        ...
        if(flag){
            ...
            $.ajax({
                ...
                success: function(data) {
                    var flag = 1;
                    if (pre_qty > 0) {
                        var qty = data.qty || data[15];
                        $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ') .qty').val(qty);
                        pos = product_code.indexOf(data.code || data[1]);
                        if(!(data.promotion || data[11]) && product_warehouse_price[pos]) {
                            ...
                            product_price[rowindex] = parseFloat((data.price || data[2]) * currencyExchangeRate) + parseFloat((data.price || data[2]) * currencyExchangeRate * customer_group_rate);
                        }
                        flag = 0;
                    ...
                    if(flag){
                        ...
                        var p_name = data.name || data[0];
                        var p_code = data.code || data[1];
                        var p_id = data.id || data[9];
                        var p_qty = data.qty || data[15];
                        var p_tax_rate = data.tax_rate || data[3];
                        var p_tax_name = data.tax_name || data[4];
                        var p_tax_method = data.tax_method || data[5];
                        var p_unit_name = data.unit_name || data[6];
                        var p_unit_operator = data.unit_operator || data[7];
                        var p_unit_operation_value = data.unit_operation_value || data[8];
                        var p_is_imei = data.is_imei || data[13];
                        var p_is_variant = data.is_variant || data[14];
                        var p_is_batch = data.is_batch || data[12];
                        var p_wholesale_price = data.wholesale_price || data[16];
                        var p_cost = data.cost || data[17];
                        var p_type = data.type || data[24];
                        var p_brand = data.brand || data[20];
                        var p_product_list = data.product_list || data[21];
                        var p_variant_list = data.variant_list || data[22];
                        var p_qty_list = data.qty_list || data[23];

                        pos = product_code.indexOf(p_code);
                        if (pos == -1) {
                            product_code.push(p_code);
                            product_name.push(p_name);
                            product_qty.push(p_qty);
                            product_type.push(p_type);
                            product_id.push(p_id);
                            product_list.push(p_product_list);
                            variant_list.push(p_variant_list);
                            qty_list.push(p_qty_list);
                            is_variant.push(p_is_variant);
                            is_imei.push(p_is_imei);
                            pos = product_code.length - 1;
                        }

                        temp_unit_name = (p_unit_name).split(',');
                        cols += '<td>' + p_name + '<button type="button" class="edit-product btn btn-link" data-toggle="modal" data-target="#editModal"> <i class="dripicons-document-edit"></i></button></td>';
                        cols += '<td>' + p_code + '</td>';
                        cols += '<td><input type="number" class="form-control qty" name="qty[]" value="'+p_qty+'" step="any" required/></td>';
                        ...
                        if(p_is_batch) {
                            cols += '<td><input type="hidden" class="form-control batch-no" value="'+(batch_no ? batch_no[pos] : '')+'" required/> <input type="hidden" class="product-batch-id" name="product_batch_id[]" value="'+(product_batch_id ? product_batch_id[pos] : '')+'"/> </td>';
                        }
                        else {
                            cols += '<td><input type="hidden" class="form-control batch-no" disabled/> <input type="hidden" class="product-batch-id" name="product_batch_id[]"/> </td>';
                        }
                        ...
                        cols += '<input type="hidden" class="product-code" name="product_code[]" value="' + p_code + '"/>';
                        cols += '<input type="hidden" class="product-id" name="product_id[]" value="' + p_id + '"/>';
                        cols += '<input type="hidden" class="sale-unit" name="sale_unit[]" value="' + temp_unit_name[0] + '"/>';
                        cols += '<input type="hidden" class="net_unit_price" name="net_unit_price[]" />';
                        cols += '<input type="hidden" class="discount-value" name="discount[]" />';
                        cols += '<input type="hidden" class="tax-rate" name="tax_rate[]" value="' + p_tax_rate + '"/>';
                        cols += '<input type="hidden" class="tax-value" name="tax[]" />';
                        cols += '<input type="hidden" class="subtotal-value" name="subtotal[]" />';
                        
                        var imei_val = data.imei_number || data[18] || '';
                        cols += '<input type="hidden" class="imei-number" name="imei_number[]" value="'+imei_val+'" />';
                        ...
                        if(!(data.promotion || data[11]) && product_warehouse_price[pos]) {
                            ...
                            product_price.splice(rowindex, 0, parseFloat((data.price || data[2]) * currencyExchangeRate) + parseFloat((data.price || data[2]) * currencyExchangeRate * customer_group_rate));
                        }
                        product_discount.splice(rowindex, 0, '{{number_format(0, $general_setting->decimal, '.', '')}}');
                        tax_rate.splice(rowindex, 0, parseFloat(p_tax_rate));
                        tax_name.splice(rowindex, 0, p_tax_name);
                        tax_method.splice(rowindex, 0, p_tax_method);
                        unit_name.splice(rowindex, 0, p_unit_name);
                        unit_operator.splice(rowindex, 0, p_unit_operator);
                        unit_operation_value.splice(rowindex, 0, p_unit_operation_value);
                        is_imei.splice(rowindex, 0, p_is_imei);
                        is_variant.splice(rowindex, 0, p_is_variant);
                        checkQuantity(String(p_qty), true);
                    }
                    else if(data.imei_number || data[18]) {
                        var imei_val = data.imei_number || data[18];
                        var imeiNumbers = $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('.imei-number').val();
                        if(imeiNumbers)
                            imeiNumbers += ','+imei_val;
                        else
                            imeiNumbers = imei_val;
                        $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('.imei-number').val(imeiNumbers);
                    }
    ...
    function edit()
    {
        ...
        console.log("==test==", sale_sph);
        $('input[name="edit_sph"]').val(sale_sph[rowindex]);
        $('input[name="edit_cyl"]').val(sale_cyl[rowindex]);
        $('input[name="edit_axis"]').val(sale_axis[rowindex]);
