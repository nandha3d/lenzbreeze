                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div><b>{{$lims_sale_data->created_at->format('d-m-Y')}}</b></div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <td>{{$product_data->name}}
                                                            {{-- <button type="button" class="edit-product btn btn-link" data-toggle="modal" data-target="#editModal"> <i class="dripicons-document-edit"></i></button> <input type="hidden" class="product-type" value="{{$product_data->type}}" data-sph="{{$product_sale->sph}}" data-cyl="{{$product_sale->cyl}}" data-axis="{{$product_sale->axis}}" /> --}}
                                                            <br>
                                                            <span>Base: {{$product_data->base}} </span>
                                                            <span style="margin-left:5px">Add: {{$product_data->addition}} </span>
                                                            <span style="margin-left:5px">{{$product_data->lr}} </span>
                                                        ...
                                                        {{-- <td>N/A</td> --}}
                                                        @endif
                                                        <td ><input type="text" class="form-control sph" name="sph[]" value="{{$product_sale->sph}}"  /></td>
                                                        <td ><input type="text" class="form-control cyl" name="cyl[]" value="{{$product_sale->cyl}}"  /></td>
                                                        <td ><input type="text" class="form-control axis" name="axis[]" value="{{$product_sale->axis}}"  /></td>
                                                        <td ><input type="text" class="form-control addition" name="addition[]" value="{{$product_sale->addition}}"  /></td>
                                                        <td ><input type="text" class="form-control lr" name="lr[]" value="{{$product_sale->lr}}"  /></td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <div class="input-group-prepend">
                                                                <select  name="discount_type[]" class="form-control discount_type" style="width:60px;padding: 6px;">
                                                                    <option @if($product_sale->discount_type == "Percentage") selected @endif  value="Percentage">%</option>
                                                                    <option @if($product_sale->discount_type == "Flat") selected @endif value="Flat">F</option>
                                                                </select>
                                                                <input style="width:60px" type=" text" class="form-control discount_value update_product" name="discount_value[]" value="{{$product_sale->discount_value}}"/> </td>
                                                            </div>

                                                        </td>
                                                        <td class="discount amt">{{ number_format((float)$product_sale->discount, $general_setting->decimal, '.', '')}}</td>
                                                        {{-- <td class="tax">{{ number_format((float)$product_sale->tax, $general_setting->decimal, '.', '')}}</td> --}}
                                                        <td class="sub-total amt">{{ number_format((float)$product_sale->total, $general_setting->decimal, '.', '')}}</td>
...
<script type="text/javascript">
    ...
    $('.order-list').on("change", 'select[name="discount_type[]"]', function() {
        rowindex = $(this).closest('tr').index();
        updateRow();
    });
    ...
    function getProduct(warehouse_id){
        ...
        $.get('{{ url("/admin/sales/getproduct-list") }}/' + warehouse_id + '?brand='+brand_id+'&category='+category_id +'&product_type='+product_type_id, function(data) {
            ...
            $.each(data, function(index, row) {
                ...
                product_code.push(row.code);
                product_name.push(row.name);
                product_qty.push(row.qty);
                product_id.push(row.id);
                product_price.push(row.price);
                qty_list.push(row.qty_list);
