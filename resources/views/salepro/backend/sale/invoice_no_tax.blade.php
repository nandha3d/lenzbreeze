    ...
    <body>
        ...
        <table style="width: 100%;border-collapse: collapse;">
            <tr>
                ...
                <td style="width:30%; text-align: middle; vertical-align: top; font-size: 14px; font-bold:bold">
                    <h3> Estimate </h3>
                </td>
                <td style="padding:5px -19px;width:30%;text-align:right;">
                    <div style="display: flex;justify-content: space-between">
                        <span>EST NO:</span> <span>{{$lims_sale_data->reference_no}}</span>
                    </div>
                    <div style="display: flex;justify-content: space-between">
        ...
        <table dir="@if( Config::get('app.locale') == 'ar' || $general_setting->is_rtl){{'rtl'}}@endif" style="width: 100%;border-collapse: collapse;">
            ...
            ?>
            <tr style="">
                <td style=" border-right:1px solid #222;border-left:1px solid #222;padding:1px 3px;text-align: center;">{{$key+1}}</td>
            ...
            @endforeach
            {{-- adding extra space --}}
            @if((count($lims_product_sale_data) * 50) < 500)
            <tr style="height:{{500 - (count($lims_product_sale_data) * 50) }}px">
            ...
            <tr>
                ...
                <td class="td-text" style="border:1px solid #222;padding:1px 3px;text-align: center;font-size: 15px;">{{number_format((float)$lims_sale_data->shipping_cost ,$general_setting->decimal, '.', ',')}}</td>
            </tr>
            <tr>
