                                        ...
                                        <div class="table-responsive mt-3">
                                            <table id="myTable" class="table table-hover order-list">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                    <?php
                                                        $product_data = DB::connection('salepro')->table('products')->find($product_return->product_id);
                                                        ...
                                                        $tax = DB::connection('salepro')->table('taxes')->where('rate',$product_return->tax_rate)->first();
                                                        $unit_name = array();
                                                        $unit_operator = array();
                                                    ...
                                                    ?>
                                                        ...
                                                        <td class="net_unit_price">{{ number_format((float)$product_return->net_unit_price, $general_setting->decimal, '.', '')}} </td>
