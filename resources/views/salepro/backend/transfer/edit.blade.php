                                        ...
                                        <div class="table-responsive mt-3">
                                            <table id="myTable" class="table table-hover order-list">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                    <?php
                                                        $product_data = DB::connection('salepro')->table('products')->find($product_transfer->product_id);
                                                        ...
                                                        $tax = DB::connection('salepro')->table('taxes')->where('rate', $product_transfer->tax_rate)->first();
                                                ...
                                                <tfoot class="tfoot active">
                                                    ...
                                                    <th></th>
                                                    <th id="total-tax">{{ number_format((float)$lims_transfer_data->total_tax, $general_setting->decimal, '.', '')}}</th>
                                                    <th id="total">{{ number_format((float)$lims_transfer_data->total_cost, $general_setting->decimal, '.', '')}}</th>
                                                    <th><i class="dripicons-trash"></i></th>
                                                </tfoot>
                                            </table>
                                        </div>
