...
<script type="text/javascript">
  ...
  $(document).on("click", "table.deposit-list .edit-btn", function(event) {
    ...
    var columns = [{"data": "key"}, {"data": "id"}, {"data": "customer_group"}, {"data": "customer_details"},{"data": "place"}, {"data": "discount_plan"}, {"data": "reward_point"}, {"data": "deposited_balance"}, {"data": "total_due"}];
