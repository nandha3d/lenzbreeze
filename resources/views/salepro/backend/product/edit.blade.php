                    ...
                    <div class="card-body">
                        ...
                        <form id="product-form">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Base *</strong> </label>
                                        <input type="text" name="base" class="form-control" id="base" aria-describedby="base" required value="{{$lims_product_data->base}}">
                                        <span class="validation-msg" id="base-error"></span>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Addition *</strong> </label>
                                        <input type="text" name="addition" class="form-control" id="addition" aria-describedby="addition" required value="{{$lims_product_data->addition}}">
                                        <span class="validation-msg" id="addition-error"></span>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>L/R *</strong> </label>
                                        <div class="input-group">
                                            <select name="lr" required class="form-control selectpicker" id="lr" value="{{$lims_product_data->lr}}">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <input type="hidden" name="product_type" value="{{$lims_product_data->product_type_id}}">
                                        <label>Type * </label>
                                        <div class="input-group">
                                          <select name="product_type_id" required class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Select Type..." value="{{$lims_product_data->product_type_id}}">
                                            @foreach($lims_product_type_list as $type)
...
<script type="text/javascript">
    ...
    var ptype = $("input[name='product_type']").val();
    $('select[name=product_type_id]').val(ptype);
