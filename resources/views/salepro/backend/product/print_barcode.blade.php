        ...
        select: function(event, ui) {
            ...
            $.ajax({
                ...
                success: function(responseData) {
                    ...
                    if(flag){
                        var newRow = $('<tr data-imagedata="'+data.barcode_image+'" data-price="'+data.price+'" data-promo-price="'+data.promotion_price+'" data-currency="'+data.currency+'" data-currency-position="'+data.currency_position+'">');
                        var cols = '';
                        cols += '<td>' + data.name + '</td>';
                        cols += '<td class="product-code">' + data.code + '</td>';
                        ...
                        cols += '<td><input type="hidden" name="products['+ key +'][product_id]" value="'+data.id+'"></td>';
                        cols += '<td><input type="hidden" name="products['+ key +'][product_name]" value="'+data.name+'"></td>';
                        cols += '<td><input type="hidden" name="products['+ key +'][sub_sku]" value="'+data.code+'"></td>';
                        cols += '<td><input type="hidden" name="products['+ key +'][product_price]" value="'+data.price+'"></td>';
                        cols += '<td><input type="hidden" name="products['+ key +'][product_promo_price]" value="'+data.promotion_price+'"></td>';
                        cols += '<td><input type="hidden" name="products['+ key +'][currency]" value="'+data.currency+'"></td>';
                        cols += '<td><input type="hidden" name="products['+ key +'][currency_position]" value="'+data.currency_position+'"></td>';
