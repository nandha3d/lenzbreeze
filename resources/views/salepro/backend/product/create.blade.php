                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="base" class="form-control" id="base" aria-describedby="base" required>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="addition" class="form-control" id="addition" aria-describedby="addition" required>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <select name="lr" required class="form-control selectpicker" id="lr">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group pos">
                                          <select name="product_type" required class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Select Type...">
