		    ...
		    <div class="content">
		        ...
		        <form action="{{ route('saas-install-process') }}" method="post">
		            ...
		            <fieldset>
		                ...
		                <input type='text' value="GD4WCRHF-09JX-RDWQ-8HO4-V4XNPMYG7O5S" placeholder="Ex: 123456789XXXXXXXX" required class="form-control" name="purchasecode">
		                ...
		                <input type='text' value="http://saleprosaas.test" required placeholder="Ex: http://saleprosaas.com" class="form-control" name="central_domain">

                        <label>DB Prefix</label>
		                <input type='text' value="saas" required placeholder="Ex: salepro_" class="form-control" name="db_prefix">

                        <label>Database Host</label>
		                <input type='text' value="localhost" required placeholder="Ex: localhost" class="form-control" name="db_host">

                        <label>Database Port</label>
		                <input type='number' value="3306" required placeholder="Ex: 3306" class="form-control" name="db_port">

                        <label>Database Username</label>
		                <input type='text' value="root" required placeholder="Ex: salepro2023" class="form-control" name="db_username">

                        <label>Database Password</label>
		                <input type='password' value="irfan95" required placeholder="Ex: PXsfdf1542" class="form-control" name="db_password">

                        <label>Database Name</label>
		                <input type='text' value="salepro_test" placeholder="Ex: saleprosaas_db" required class="form-control" name="db_name">
