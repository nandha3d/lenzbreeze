    ...
    <div class="col-md-6 offset-md-3">
        <div class='wrapper'>
            ...
            <div class="content">
                ...
                <br/><?php echo $ltext; ?><br/>Sorry. The requirements of SalepPro is not available on your server. Please contact with us- hello@lion-coders.com with this code- <?php echo $passed; ?> Or contact with your server administrator.<br><br>
