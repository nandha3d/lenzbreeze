        ...
        <table id="adjustment-table" class="table purchase-list">
            ...
            <tbody>
                ...
                <tr data-id="{{$adjustment->id}}">
                    ...
                    <?php $warehouse = DB::connection('salepro')->table('warehouses')->find($adjustment->warehouse_id) ?>
                    <td>{{ $warehouse->name }}</td>
                    <td>
                    <?php
                    	$product_adjustment_data = DB::connection('salepro')->table('product_adjustments')->where('adjustment_id', $adjustment->id)->get();
                    	foreach ($product_adjustment_data as $key => $product_adjustment) {
                            if($product_adjustment->variant_id) {
                                $product = DB::connection('salepro')->table('products')
                                ...
                                $product = DB::connection('salepro')->table('products')->select('name','code')->find($product_adjustment->product_id);
                            }
