                                            ...
                                            <table id="myTable" class="table table-hover order-list">
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php
                                                        ...
                                                        $customer = DB::connection('salepro')->table('customers')->find($lims_quotation_data->customer_id);

                                                        $customer_group = DB::connection('salepro')->table('customer_groups')->find($customer->customer_group_id);
                                                        ...
                                                        $tax = DB::connection('salepro')->table('taxes')->where('rate', $product_quotation->tax_rate)->first();
