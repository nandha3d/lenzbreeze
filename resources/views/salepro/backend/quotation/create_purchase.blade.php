                                        ...
                                        <div class="table-responsive mt-3">
                                            <table id="myTable" class="table table-hover order-list">
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php
                                                        $product_data = DB::connection('salepro')->table('products')->find($product_quotation->product_id);
                                                    ...
                                                    <tr>
                                                        <?php
                                                            ...
                                                            $tax_data = DB::connection('salepro')->table('taxes')->where('rate', $product_quotation->tax_rate)->first();
                                                        ...
                                                        <td class="net_unit_cost">{{ number_format((float)$net_unit_cost, $general_setting->decimal, '.', '')}} </td>
                                                        <td class="discount">{{ number_format((float)$product_quotation->discount, $general_setting->decimal, '.', '')}}</td>
                                                        <td class="tax">{{ number_format((float)$tax, $general_setting->decimal, '.', '')}}</td>
                                                        <td class="sub-total">{{ number_format((float)$sub_total, $general_setting->decimal, '.', '')}}</td>
                                                ...
                                                <tfoot class="tfoot active">
                                                    ...
                                                    <th id="total">{{ number_format((float)$lims_quotation_data->total_cost, $general_setting->decimal, '.', '')}}</th>
                                                    <th><i class="dripicons-trash"></i></th>
                                                </tfoot>
                                            </table>
                                        </div>
