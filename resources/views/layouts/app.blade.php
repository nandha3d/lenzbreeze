...
<body class="min-h-screen flex flex-col bg-warm-50">
    {{-- Header --}}
    ...
    {{-- WhatsApp Float --}}
    <a href="https://wa.me/{{ App\Models\Setting::get('company_whatsapp', '914712345678') }}?text=Hi,%20I%20would%20like%20to%20know%20more%20about%20Lenz%20Breeze%20products." target="_blank" class="whatsapp-float" aria-label="Chat on WhatsApp">
