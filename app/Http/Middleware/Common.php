...
class Common
{
    ...
    public function handle(Request $request, Closure $next)
    {
        ...
        $configData = [
            ...
            'is_packing_slip' => $general_setting->is_packing_slip ?? 0,
            ...
            'is_zatca' => $general_setting->is_zatca ?? 0,
            'company_name' => $general_setting->company_name ?? 'SalePro',
            'vat_registration_number' => $general_setting->vat_registration_number ?? '',
            'without_stock' => $general_setting->without_stock ?? 'no',
