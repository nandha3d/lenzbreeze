...
class PurchaseController extends Controller
{
    ...
    public function purchaseData(Request $request)
    {
        ...
        if(!empty($purchases))
        {
            ...
            \Log::error('DataTables Error (Purchase): ' . $e->getMessage() . ' Line: ' . $e->getLine(), ['exception' => $e]);
            ...
            ], 200); // return 200 so DataTables can at least show the message instead of crashing with invalid JSON
        }
    }
